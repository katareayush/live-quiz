  ...
  import { generateRoomCode } from '../../utils/roomCodeUtils';
  ...
  const CreateQuizPage: React.FC = () => {
    ...
    const saveQuiz = async (e: FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        // First generate the room code
        const roomCode = await generateRoomCode(db);
  
        // Prepare quiz data with room code
        const quizData = {
          ...
          roomCode: roomCode, // Add room code to quiz data
          metadata: {
        ...
        const quizDocRef = await addDoc(quizCollectionRef, quizData);
  
        // Then create the room with reference to the quiz
        ...
        console.log('Quiz and room created successfully with ID:', quizDocRef.id);
        console.log('Room code:', roomCode);
        
        // Redirect to the quiz page
        router.push(`/quiz/${quizDocRef.id}?roomCode=${roomCode}`);
      } catch (error) {
